...
export default function WhyUs() {
  ...
  return (
    <section id="whyUs" className="mt-20">
      <h2 className="text-center text-3xl font-poppins font-bold mb-4">
        Why Choose Us?
      </h2>
      <div className="flex flex-col md:flex-row gap-8 items-center justify-center mb-4">
        {whyUsData.map((item, index) => (
          <div
            key={index}
            className="w-[373px] h-[249px] p-6 border border-gray-100 rounded-lg shadow-sm bg-gray-100 flex flex-col items-center justify-center"
          >
            <div className="text-4xl mb-4 text-subColor">{item.icon}</div>
            <div className="flex flex-col items-center justify-center">
              <h5 className="mb-2 text-xl font-bold font-poppins text-black text-center">
                {item.title}
              </h5>
              <p className="text-center text-sm font-normal text-black-500">
                {item.desc}
              </p>
            </div>
          </div>
