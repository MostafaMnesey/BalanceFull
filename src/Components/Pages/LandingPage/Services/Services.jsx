            ...
            <div className="container">
                <div className='flex flex-col items-center justify-center md:flex-row md:items-center md:justify-center gap-6'>
                    {servicesData.map((service, index) => (
                        <div
                            key={index}
                            className="w-96 bg-white rounded-lg shadow-md dark:bg-white transform transition-transform duration-300 hover:translate-y-2"
                        >
                            <img className="rounded-t-lg w-full" src={service.image} alt={service.title} />
                            <div className="p-5">
                                <div className='flex flex-col gap-1'>
                                    <h5 className="mb-2 text-xl leading-none font-bold tracking-tight text-gray-900 dark:text-black">
                                        {service.title}
                                    </h5>
                                    <p className="text-sm mb-3 font-normal leading-relaxed text-black-500 dark:text-black-500">
                                        {service.description}
                                    </p>
                                </div>
                                <div className='flex items-center gap-1'>
                                    <Link
                                        to="#"
                                        className="inline-flex items-center py-2 text-md font-medium text-black-500 bg-transparent rounded-lg hover:underline"
                                    >
                                        {service.buttonTxt}
                                    </Link>
                                    <MdArrowOutward />
