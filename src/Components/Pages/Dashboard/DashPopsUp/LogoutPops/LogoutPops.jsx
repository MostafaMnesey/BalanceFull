...
<div className='w-2/4  bg-white shadow-lg p-6'>
    ...
    <div className="flex flex-col gap-12  ">
        <div className="flex flex-col items-center justify-center gap-3">
            ...
            <button className='capitalize bg-mainColor rounded-full px-12 py-4 text-white font-medium transition-all hover:bg-white hover:text-mainColor hover:border-2 hover:border-mainColor'>cancle </button>
