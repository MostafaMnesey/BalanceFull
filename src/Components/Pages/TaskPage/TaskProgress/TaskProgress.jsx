  ...
  const handleCloseTask = () => {
    ...
    return (
                            ...
                            <Slider {...settings}>
                                ...
                                {progressData[0].newTask.map((task, i) => (
                                    <div key={i} className="min-w-[300px]  ">
                                        <figure className=" transform transition-all duration-300 ease-in-out hover:-translate-y-2 border border-1 border-gray-100  mr-5 relative flex flex-col items-start justify-center p-14 rounded-b-lg shadow-sm bg-white h-full">
                                            <div className=" flex flex-col gap-2 w-full">
                                                ...
                                                <span className="text-sm font-semibold  font-poppins text-[#236A68] underline cursor-pointer transition-all hover:text-mainColor"onClick={() => setSelectedTask(task)} >
                                                    {task.privew}
                                                </span>
                                            </div>
       ...
       {progressData[0].onGoingTask.map((task, i) => (
                                    <div key={i} className="min-w-[300px]">
                                        <figure className="transform transition-all duration-300 ease-in-out hover:-translate-y-2 border border-gray-100 mr-5 relative flex flex-col items-start justify-center p-14 rounded-b-lg shadow-md bg-white h-full">
                                            <div className="flex flex-col gap-2 w-full">
                                                <p className="capitalize text-sm md:text-md  font-poppins font-semibold">
                                                    task:{task.task}
                                                </p>
