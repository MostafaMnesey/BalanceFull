...
export default function Post() {
  ...
  useEffect(() => {
    async function fetchPost() {
      ...
      setError(null);
      try {
        const res = await axios.get(`https://beige-wildcat-74200.zap.cloud/api/posts/${postId}`, {
          headers: {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 mt-[8%] bg-white rounded-lg shadow-md border border-gray-200">
      {/* User Info */}
