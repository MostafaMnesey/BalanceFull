                ...
                <div className=" md:flex md:justify-evenly ">
                    ...
                    <div className='grid grid-col-1 items-center justify-center  md:grid-cols-3 gap-16 md:gap-1'>
                        <div className='col-span-2 md:col-span-1'>
                            ...
                            <ul className="text-white dark:text-white font-inter text-sm font-medium flex flex-col items-center   md:items-start justify-center gap-2">
                                <li className="">
                                    <a href="https://flowbite.com/" className="hover:underline">Home</a>
                                </li>
                                <li>
                                    <a href="https://tailwindcss.com/" className="hover:underline">Doctors </a>
                                </li>
                                <li>
                                    <a href="https://tailwindcss.com/" className="hover:underline">Tasks </a>
                                </li>
                                <li>
                        ...
                        <div className='col-span-2 md:col-span-1'>
                            <h2 className="text-center md:text-left  mb-4 text-xl md:text-lgfont-inter font-bold text-white capitalize dark:text-white">Services</h2>
                            <ul className="text-white dark:text-white font-inter text-sm font-medium flex flex-col gap-2 md:items-start items-center justify-center">
                                <li className="">
                                    <a href="https://flowbite.com/" className="hover:underline">Why choose us</a>
                                </li>
                                <li>
                                    <a href="https://tailwindcss.com/" className="hover:underline">About the program </a>
                                </li>
                                <li>
                                    <a href="https://tailwindcss.com/" className="hover:underline">Behind the recovery </a>
                                </li>
                                <li>
                                    <a href="https://tailwindcss.com/" className="hover:underline">Top rated doctors</a>
                                </li>
                            </ul>
                        </div>
                        <div className='col-span-2 md:col-span-1 '>
                            ...
                            <ul className="text-white dark:text-white font-inter text-sm font-medium flex flex-col items-center justify-center md:items-start  gap-2">
                                <li className="">
